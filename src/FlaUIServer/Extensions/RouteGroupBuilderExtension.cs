...
public static class RouteGroupBuilderExtension
{
    public static RouteGroupBuilder MapSessionEndpoints(this RouteGroupBuilder groupBuilder)
    {
        ...
        groupBuilder.MapDelete("/session/{sessionId}",
        ...
        groupBuilder.MapPost("/session/{sessionId}/execute",
        ...
        groupBuilder.MapPost("/session/{sessionId}/element/{elementId}/click",
        ...
        groupBuilder.MapPost("/session/{sessionId}/element/{elementId}/clear",
                async ([FromRoute] Guid sessionId, [FromRoute] Guid elementId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/title",
                async ([FromRoute] Guid sessionId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/window/rect",
                async ([FromRoute] Guid sessionId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/window_handle",
                async ([FromRoute] Guid sessionId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/window_handles",
                async ([FromRoute] Guid sessionId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/element/{elementId}/text",
                async ([FromRoute] Guid sessionId, [FromRoute] Guid elementId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/element/{elementId}/displayed",
                async ([FromRoute] Guid sessionId, [FromRoute] Guid elementId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/element/{elementId}/enabled",
                async ([FromRoute] Guid sessionId, [FromRoute] Guid elementId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/element/{elementId}/selected",
                async ([FromRoute] Guid sessionId, [FromRoute] Guid elementId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/element/{elementId}/rect",
                async ([FromRoute] Guid sessionId, [FromRoute] Guid elementId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapGet("/session/{sessionId}/element/{elementId}/attribute/{name}",
        ...
        groupBuilder.MapGet("/session/{sessionId}/screenshot",
                async ([FromRoute] Guid sessionId, IMediator mediator, CancellationToken ct) 
        ...
        groupBuilder.MapDelete("/session/{sessionId}/window",
                async ([FromRoute] Guid sessionId, IMediator mediator, CancellationToken ct)
